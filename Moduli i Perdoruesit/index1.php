    ...
    <div class="container">
        ...
        <dif class="form-box">
            ...
            <form action="" method="post">
                ...
                <input type="submit" value="Sign in" name="submit" id="signinBtn" style="flex-basis: 45%; background: #ed563b; color: #fff; height: 40px; border-radius: 20px; border: 0; outline: 0; cursor: pointer; transition: background 1s; text-align: center; line-height: 8px;">
