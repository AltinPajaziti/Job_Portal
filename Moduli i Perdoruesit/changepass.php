...
if (!(isset($_SESSION['emri_kompanise']) && $_SESSION['emri_kompanise'] != '')) {
...
<div id="alert" class="alert alert-success hide" style="position:relative;right:230px; top:-40px; background-color: #8bc34a; border: 1px solid #8bc34a; padding: 15px 20px; color: white; animation:show_slide 1s ease forwards;">
    <div class="alert-container" style="position: relative; max-width: 960px; margin: 0 auto;">
        ...
        Success alert: Fjalekalimi juaj është ndryshuar me sukses!
    </div>
</div>
...
<!-- Danger alert message -->
        ...
        <div class="form-box">
            ...
            <form action="changepass.php" method="POST">
                ...
                <div class="btn-field">
                    <button type="submit" name="buttoni">Change</button>
                </div>
            </form>
        </div>
    </div>
