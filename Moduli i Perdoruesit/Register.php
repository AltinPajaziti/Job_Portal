...
if (isset($_POST['submit'])) {
    if (empty($_POST['email']) || empty($_POST['Mbiemri']) || empty($_POST['Emri'])  || empty($_POST['Password'])) {
        $error = "Fill all fields please";
            ...
            $password =$_POST['Password'];
                ...
                $sql = "INSERT INTO Perdoruesi (email, Mbiemri, Emri,  passwordi, Foto) VALUES ('$email', '$mbiemri', '$emri',  '$password', '$foto')";
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-box">
        <div id="alert"  class="alert alert-success hide" style="position:relative;right:386px; background-color: #8bc34a; border: 1px solid #8bc34a; padding: 15px 20px; color: white; animation:show_slide 1s ease forwards;">
            ...
            <form enctype="multipart/form-data" action="Register.php"  method="post" name="form1">
                <div class="input-group" id="inputGroup">
                    <div class="input-field" id="namefield">
                        ...
                        <input type="text" placeholder="Name" name="Emri">
                    </div>
                    ...
                    <input name="userfile" type="file" style="float: left;" id="photoimg">  
                    <!-- <button style="float: left;" id="photoimg">upload Image</button> -->
