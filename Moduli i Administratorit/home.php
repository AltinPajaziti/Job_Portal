...
<br>
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">PANELI I KONTROLLIT</h1>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                        <a href="porosite.php" style="text-decoration: none;"><a href="perdoruesit.php" style="text-decoration:none;">Përdoruesit</a></a>
                                    </div>
                                </div>
                                <div class="col-auto">
                                    <!-- 1 -->
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                        <a href="shpalljet.php" style="text-decoration:none;">Shpalljet</a>
                                    </div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-info shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a href="aplikimet.php" style="text-decoration:none;">Aplikimet</a>
                                    </div>
                                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <a href="vrejtjet.php" style="text-decoration: none;">Vërejtjet</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <a href="location.php" style="text-decoration: none;">Lokacioni</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <a href="Kategorite.php" style="text-decoration: none;">Kategorite</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto">
                                <i class="fa fa-info-circle fa-2x text-gray-300" aria-hidden="true"></i>
                                </div>
                        </div>
                    </div>
                </div>
