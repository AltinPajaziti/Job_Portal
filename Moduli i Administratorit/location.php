...
if (isset($_POST['fshi'])) {
    ...
    $crud->Delete('lokacioni', ['kolona' => 'id_lokacioni', 'value' => $id_to_delete]);
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <a href="addLocation.php" style="color:white" class="btn btn-primary" id="buttoni">Add more</a>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($stmt)) {
                                ...
                                echo '<td>
                                <form action="location.php" method="post" onsubmit="return confirm(\'A jeni te sigurt qe doni ta fshini këtë lokacion?\');">
                                    <input type="hidden" name="fshi" value="' . $row['id_lokacioni'] . '">
