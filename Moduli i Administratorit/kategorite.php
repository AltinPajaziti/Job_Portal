...
if (isset($_POST['fshi'])) {
    ...
    $crud->Delete('kategorite', ['kolona' => 'id_Kategoria', 'value' => $id_to_delete]);
...
<body id="body-pd">
    ...
    <br>
        <h1 class="h3 mb-2 text-gray-800">KATEGORITE</h1>
        <p class="mb-4">Paraqitja e Kategorive.</p>


        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="color:#20525C !important;">Të Dhënat e Kategorive</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <a href="addkategori.php" style="color:white" class="btn btn-primary" id="buttoni">Add more</a>
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($stmt)) {
                                ...
                                echo '<td>' . $row['Emri_kategorise'] . '</td>';
                                
                                echo '<td>
        <form action="kategorite.php" method="post" onsubmit="return confirm(\'A jeni te sigurt qe doni ta fshini këtë kategori?\');">
            <input type="hidden" name="fshi" value="' . $row['id_Kategoria'] . '">
